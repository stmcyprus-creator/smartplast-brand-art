...
const steps = [
  ...
  { n: "05", title: "Доставляем тираж", text: "Доставляем до адреса в Республике Казахстан." },
];
    ...
    <section id="delivery" className="mx-auto max-w-7xl px-5 pb-24 lg:px-8">
      <div className="glass grid gap-8 rounded-[2rem] p-8 sm:p-12 lg:grid-cols-[1fr_auto] lg:items-center">
        <div>
          <SectionTitle
            kicker="Доставка"
            title="Доставляем до адреса в Республике Казахстан"
            text="Привозим тираж до вашего адреса в любом городе Республики Казахстан. Возможна отгрузка со склада самовывозом."
          />
        </div>
        <Reveal delay={100}>
          <div className="flex flex-wrap gap-4">
            {[
              { icon: Truck, t: "До адреса", s: "по всему Казахстану" },
              { icon: Package, t: "Любой тираж", s: "аккуратная упаковка" },
              { icon: Handshake, t: "Самовывоз", s: "со склада" },
            ].map((d) => (
