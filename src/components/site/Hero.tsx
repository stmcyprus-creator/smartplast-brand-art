...
const floating = [
  ...
  { icon: Palette, text: "100% под ваш дизайн", pos: "bottom-10 left-4 sm:left-10 lg:left-20" },
];
  ...
  return (
    <section id="top" ref={wrapRef} className="relative h-[260vh]">
      ...
      <div className="sticky top-0 flex h-screen items-center overflow-hidden">
        ...
        <div className="relative mx-auto w-full max-w-5xl px-5 pt-24 text-center lg:px-8">
          <Reveal>
          ...
          <div
            className={`mt-8 flex items-center justify-center gap-2 text-xs uppercase tracking-[0.2em] text-muted-foreground transition-opacity duration-500 ${scrolled ? "opacity-0" : "opacity-100"}`}
          >
